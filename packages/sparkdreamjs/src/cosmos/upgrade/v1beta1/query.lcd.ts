...
export class LCDQueryClient {
  ...
  currentPlan = async (_params: QueryCurrentPlanRequest = {}): Promise<QueryCurrentPlanResponse> => {
  ...
  upgradedConsensusState = async (params: QueryUpgradedConsensusStateRequest): Promise<QueryUpgradedConsensusStateResponse> => {

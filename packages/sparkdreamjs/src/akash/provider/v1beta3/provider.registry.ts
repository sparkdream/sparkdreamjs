...
export const registry: ReadonlyArray<[string, TelescopeGeneratedType<any, any, any>]> = [["/akash.provider.v1beta3.MsgCreateProvider", MsgCreateProvider], ["/akash.provider.v1beta3.MsgUpdateProvider", MsgUpdateProvider], ["/akash.provider.v1beta3.MsgDeleteProvider", MsgDeleteProvider]];

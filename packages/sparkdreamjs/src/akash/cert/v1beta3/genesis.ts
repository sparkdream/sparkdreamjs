 ...
 * @see proto type: akash.cert.v1beta3.GenesisCertificate
 */
...
export interface GenesisCertificateProtoMsg {
  typeUrl: "/akash.cert.v1beta3.GenesisCertificate";
  value: Uint8Array;
}
/**
 * GenesisCertificate defines certificate entry at genesis
 ...
 * @name GenesisState
 * @package akash.cert.v1beta3
 * @see proto type: akash.cert.v1beta3.GenesisState
 */
export interface GenesisState {
  certificates: GenesisCertificate[];
}
export interface GenesisStateProtoMsg {
  typeUrl: "/akash.cert.v1beta3.GenesisState";
  value: Uint8Array;
}
/**
 * GenesisState defines the basic genesis state used by cert module

...
import { MsgSignProviderAttributes, MsgSignProviderAttributesResponse, MsgDeleteProviderAttributes, MsgDeleteProviderAttributesResponse } from "./msg";
...
export class MsgClientImpl implements Msg {
  ...
  signProviderAttributes = async (request: MsgSignProviderAttributes): Promise<MsgSignProviderAttributesResponse> => {
    ...
    const promise = this.rpc.request("akash.audit.v1.Msg", "SignProviderAttributes", data);
  ...
  deleteProviderAttributes = async (request: MsgDeleteProviderAttributes): Promise<MsgDeleteProviderAttributesResponse> => {
    ...
    const promise = this.rpc.request("akash.audit.v1.Msg", "DeleteProviderAttributes", data);

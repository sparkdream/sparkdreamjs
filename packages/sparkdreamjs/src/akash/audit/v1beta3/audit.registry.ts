...
export const registry: ReadonlyArray<[string, TelescopeGeneratedType<any, any, any>]> = [["/akash.audit.v1beta3.MsgSignProviderAttributes", MsgSignProviderAttributes], ["/akash.audit.v1beta3.MsgDeleteProviderAttributes", MsgDeleteProviderAttributes]];

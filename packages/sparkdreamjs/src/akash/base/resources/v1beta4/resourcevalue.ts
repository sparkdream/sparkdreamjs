 ...
 * @see proto type: akash.base.resources.v1beta4.ResourceValue
 */
export interface ResourceValue {
  val: Uint8Array;
}
export interface ResourceValueProtoMsg {
  typeUrl: "/akash.base.resources.v1beta4.ResourceValue";
  value: Uint8Array;
}
/**
 * Unit stores cpu, memory and storage metrics.
 * @name ResourceValueAmino
 * @package akash.base.resources.v1beta4
 * @see proto type: akash.base.resources.v1beta4.ResourceValue
 */
...
export interface ResourceValueAminoMsg {
  type: "/akash.base.resources.v1beta4.ResourceValue";

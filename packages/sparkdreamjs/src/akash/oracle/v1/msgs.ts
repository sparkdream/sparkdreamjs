//@ts-nocheck
import { DataID, DataIDAmino, PriceDataState, PriceDataStateAmino } from "./prices";
 ...
 * @see proto type: akash.oracle.v1.MsgAddPriceEntry
 */
...
export interface MsgAddPriceEntryAmino {
   ...
   * price contains the price value and timestamp for this entry
   */
  price: PriceDataStateAmino;
}
export interface MsgAddPriceEntryAminoMsg {
  type: "/akash.oracle.v1.MsgAddPriceEntry";
 ...
 * @package akash.oracle.v1
 * @see proto type: akash.oracle.v1.MsgAddPriceEntryResponse
 */
export interface MsgAddPriceEntryResponse {}
export interface MsgAddPriceEntryResponseProtoMsg {
  typeUrl: "/akash.oracle.v1.MsgAddPriceEntryResponse";
  value: Uint8Array;
}
/**
 * MsgAddPriceEntryResponse defines the Msg/MsgAddDPriceEntry response type.
...
export interface MsgAddPriceEntryResponseAminoMsg {
  type: "/akash.oracle.v1.MsgAddPriceEntryResponse";
 ...
 * @package akash.oracle.v1
 * @see proto type: akash.oracle.v1.MsgUpdateParams
 */
 ...
 * @package akash.oracle.v1
 * @see proto type: akash.oracle.v1.MsgUpdateParamsResponse
 */
export interface MsgUpdateParamsResponse {}
export interface MsgUpdateParamsResponseProtoMsg {
  typeUrl: "/akash.oracle.v1.MsgUpdateParamsResponse";
  value: Uint8Array;
}
/**
 * MsgUpdateParamsResponse defines the response structure for executing a
...
export interface MsgUpdateParamsResponseAminoMsg {
  type: "/akash.oracle.v1.MsgUpdateParamsResponse";
...
function createBaseMsgAddPriceEntry(): MsgAddPriceEntry {
  return {
    ...
    price: PriceDataState.fromPartial({})
  };
}
/**
 * MsgAddPriceEntry defines an SDK message to add oracle price entry.
...
export const MsgAddPriceEntry = {
  ...
  encode(message: MsgAddPriceEntry, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.price !== undefined) {
      PriceDataState.encode(message.price, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial(object: DeepPartial<MsgAddPriceEntry>): MsgAddPriceEntry {
    ...
    message.price = object.price !== undefined && object.price !== null ? PriceDataState.fromPartial(object.price) : undefined;
    return message;
  },
  fromAmino(object: MsgAddPriceEntryAmino): MsgAddPriceEntry {
    ...
    if (object.price !== undefined && object.price !== null) {
      message.price = PriceDataState.fromAmino(object.price);
    }
    return message;
  },
  toAmino(message: MsgAddPriceEntry): MsgAddPriceEntryAmino {
    ...
    obj.price = message.price ? PriceDataState.toAmino(message.price) : PriceDataState.toAmino(PriceDataState.fromPartial({}));
    return obj;
  },

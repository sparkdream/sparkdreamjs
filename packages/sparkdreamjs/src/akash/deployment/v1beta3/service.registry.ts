...
export const registry: ReadonlyArray<[string, TelescopeGeneratedType<any, any, any>]> = [["/akash.deployment.v1beta3.MsgCreateDeployment", MsgCreateDeployment], ["/akash.deployment.v1beta3.MsgDepositDeployment", MsgDepositDeployment], ["/akash.deployment.v1beta3.MsgUpdateDeployment", MsgUpdateDeployment], ["/akash.deployment.v1beta3.MsgCloseDeployment", MsgCloseDeployment], ["/akash.deployment.v1beta3.MsgCloseGroup", MsgCloseGroup], ["/akash.deployment.v1beta3.MsgPauseGroup", MsgPauseGroup], ["/akash.deployment.v1beta3.MsgStartGroup", MsgStartGroup]];

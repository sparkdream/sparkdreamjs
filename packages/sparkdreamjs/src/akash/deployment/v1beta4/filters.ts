 ...
 * @see proto type: akash.deployment.v1beta4.DeploymentFilters
 */
...
export interface DeploymentFiltersProtoMsg {
  typeUrl: "/akash.deployment.v1beta4.DeploymentFilters";
  value: Uint8Array;
}
/**
 * DeploymentFilters defines filters used to filter deployments.
 ...
 * @name GroupFilters
 * @package akash.deployment.v1beta4
 * @see proto type: akash.deployment.v1beta4.GroupFilters
 */
...
export interface GroupFiltersProtoMsg {
  typeUrl: "/akash.deployment.v1beta4.GroupFilters";
  value: Uint8Array;
}
/**
 * GroupFilters defines filters used to filter groups

...
export class MsgClientImpl implements Msg {
  ...
  createDeployment = async (request: MsgCreateDeployment): Promise<MsgCreateDeploymentResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "CreateDeployment", data);
  ...
  updateDeployment = async (request: MsgUpdateDeployment): Promise<MsgUpdateDeploymentResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "UpdateDeployment", data);
  ...
  closeDeployment = async (request: MsgCloseDeployment): Promise<MsgCloseDeploymentResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "CloseDeployment", data);
  ...
  closeGroup = async (request: MsgCloseGroup): Promise<MsgCloseGroupResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "CloseGroup", data);
  ...
  pauseGroup = async (request: MsgPauseGroup): Promise<MsgPauseGroupResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "PauseGroup", data);
  ...
  startGroup = async (request: MsgStartGroup): Promise<MsgStartGroupResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "StartGroup", data);
  ...
  updateParams = async (request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> => {
    ...
    const promise = this.rpc.request("akash.deployment.v1beta5.Msg", "UpdateParams", data);

...
export class MsgClientImpl implements Msg {
  ...
  createBid = async (request: MsgCreateBid): Promise<MsgCreateBidResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "CreateBid", data);
  ...
  closeBid = async (request: MsgCloseBid): Promise<MsgCloseBidResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "CloseBid", data);
  ...
  withdrawLease = async (request: MsgWithdrawLease): Promise<MsgWithdrawLeaseResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "WithdrawLease", data);
  ...
  createLease = async (request: MsgCreateLease): Promise<MsgCreateLeaseResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "CreateLease", data);
  ...
  closeLease = async (request: MsgCloseLease): Promise<MsgCloseLeaseResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "CloseLease", data);
  ...
  updateParams = async (request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Msg", "UpdateParams", data);

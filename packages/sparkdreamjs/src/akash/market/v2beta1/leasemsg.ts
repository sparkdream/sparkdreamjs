 ...
 * @see proto type: akash.market.v2beta1.MsgCreateLease
 */
...
export interface MsgCreateLeaseAminoMsg {
  type: "/akash.market.v2beta1.MsgCreateLease";
 ...
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.MsgCreateLeaseResponse
 */
export interface MsgCreateLeaseResponse {}
export interface MsgCreateLeaseResponseProtoMsg {
  typeUrl: "/akash.market.v2beta1.MsgCreateLeaseResponse";
  value: Uint8Array;
}
/**
 * MsgCreateLeaseResponse is the response from creating a lease.
...
export interface MsgCreateLeaseResponseAminoMsg {
  type: "/akash.market.v2beta1.MsgCreateLeaseResponse";
 ...
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.MsgWithdrawLease
 */
...
export interface MsgWithdrawLeaseAminoMsg {
  type: "/akash.market.v2beta1.MsgWithdrawLease";
 ...
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.MsgWithdrawLeaseResponse
 */
export interface MsgWithdrawLeaseResponse {}
export interface MsgWithdrawLeaseResponseProtoMsg {
  typeUrl: "/akash.market.v2beta1.MsgWithdrawLeaseResponse";
  value: Uint8Array;
}
/**
 * MsgWithdrawLeaseResponse defines the Msg/WithdrawLease response type.
...
export interface MsgWithdrawLeaseResponseAminoMsg {
  type: "/akash.market.v2beta1.MsgWithdrawLeaseResponse";
 ...
 * @name MsgCloseLease
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.MsgCloseLease
 */
...
export interface MsgCloseLeaseAminoMsg {
  type: "/akash.market.v2beta1.MsgCloseLease";
 ...
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.MsgCloseLeaseResponse
 */
export interface MsgCloseLeaseResponse {}
export interface MsgCloseLeaseResponseProtoMsg {
  typeUrl: "/akash.market.v2beta1.MsgCloseLeaseResponse";
  value: Uint8Array;
}
/**
 * MsgCloseLeaseResponse defines the Msg/CloseLease response type.
...
export interface MsgCloseLeaseResponseAminoMsg {
  type: "/akash.market.v2beta1.MsgCloseLeaseResponse";

 ...
 * @see proto type: akash.market.v2beta1.LeaseFilters
 */
...
export interface LeaseFiltersProtoMsg {
  typeUrl: "/akash.market.v2beta1.LeaseFilters";
  value: Uint8Array;
}
/**
 * LeaseFilters defines flags for lease list filtering.
...
export interface LeaseFiltersAminoMsg {
  type: "/akash.market.v2beta1.LeaseFilters";
 ...
 * @name BidFilters
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.BidFilters
 */
...
export interface BidFiltersProtoMsg {
  typeUrl: "/akash.market.v2beta1.BidFilters";
  value: Uint8Array;
}
/**
 * BidFilters defines flags for bid list filter.
...
export interface BidFiltersAminoMsg {
  type: "/akash.market.v2beta1.BidFilters";
 ...
 * @name OrderFilters
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.OrderFilters
 */
...
export interface OrderFiltersProtoMsg {
  typeUrl: "/akash.market.v2beta1.OrderFilters";
  value: Uint8Array;
}
/**
 * OrderFilters defines flags for order list filter
...
export interface OrderFiltersAminoMsg {
  type: "/akash.market.v2beta1.OrderFilters";

...
export class QueryClientImpl implements Query {
  ...
  orders = async (request: QueryOrdersRequest): Promise<QueryOrdersResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Orders", data);
  ...
  order = async (request: QueryOrderRequest): Promise<QueryOrderResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Order", data);
  ...
  bids = async (request: QueryBidsRequest): Promise<QueryBidsResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Bids", data);
  ...
  bid = async (request: QueryBidRequest): Promise<QueryBidResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Bid", data);
  ...
  leases = async (request: QueryLeasesRequest): Promise<QueryLeasesResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Leases", data);
  ...
  lease = async (request: QueryLeaseRequest): Promise<QueryLeaseResponse> => {
    ...
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Lease", data);
    return promise.then(data => QueryLeaseResponse.decode(new BinaryReader(data)));
  };
  /* Params returns the total set of market parameters. */
  params = async (request: QueryParamsRequest = {}): Promise<QueryParamsResponse> => {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("akash.market.v2beta1.Query", "Params", data);

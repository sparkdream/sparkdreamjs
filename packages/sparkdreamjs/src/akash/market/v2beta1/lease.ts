 ...
 * @see proto type: akash.market.v2beta1.LeaseID
 */
...
export interface LeaseIDProtoMsg {
  typeUrl: "/akash.market.v2beta1.LeaseID";
  value: Uint8Array;
}
/**
 * LeaseID stores bid details of lease.
...
export interface LeaseIDAminoMsg {
  type: "/akash.market.v2beta1.LeaseID";
  value: LeaseIDAmino;
}
/**
 ...
 * @name Lease
 * @package akash.market.v2beta1
 * @see proto type: akash.market.v2beta1.Lease
 */
...
export interface LeaseProtoMsg {
  typeUrl: "/akash.market.v2beta1.Lease";
  value: Uint8Array;
}
/**
 * Lease stores LeaseID, state of lease and price.
...
export interface LeaseAminoMsg {
  type: "/akash.market.v2beta1.Lease";
  value: LeaseAmino;
}

 ...
 * @see proto type: akash.epochs.v1beta1.EpochInfo
 */
...
export interface EpochInfoProtoMsg {
  typeUrl: "/akash.epochs.v1beta1.EpochInfo";
  value: Uint8Array;
}
/**
 * EpochInfo is a struct that describes the data going into
...
export interface EpochInfoAminoMsg {
  type: "/akash.epochs.v1beta1.EpochInfo";
 ...
 * @name GenesisState
 * @package akash.epochs.v1beta1
 * @see proto type: akash.epochs.v1beta1.GenesisState
 */
export interface GenesisState {
  epochs: EpochInfo[];
}
export interface GenesisStateProtoMsg {
  typeUrl: "/akash.epochs.v1beta1.GenesisState";
  value: Uint8Array;
}
/**
 * GenesisState defines the epochs module's genesis state.
...
export interface GenesisStateAminoMsg {
  type: "/akash.epochs.v1beta1.GenesisState";

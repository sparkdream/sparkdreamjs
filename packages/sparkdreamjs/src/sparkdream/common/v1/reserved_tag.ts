 ...
 * Storage is owned by x/forum; other modules check reservation via the TagKeeper interface.
 * @name ReservedTag
 * @package sparkdream.common.v1
 * @see proto type: sparkdream.common.v1.ReservedTag
 */
...
export interface ReservedTagProtoMsg {
  typeUrl: "/sparkdream.common.v1.ReservedTag";
  value: Uint8Array;
}
/**
 * ReservedTag defines a tag reserved by authority (governance or council).
...
export interface ReservedTagAminoMsg {
  type: "/sparkdream.common.v1.ReservedTag";

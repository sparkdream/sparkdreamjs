...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    sparkdream: {
      blog: (await import("./blog/query.rpc.Query")).createRpcQueryExtension(client),
      sparkdream: (await import("./sparkdream/query.rpc.Query")).createRpcQueryExtension(client)
    }
  };
};
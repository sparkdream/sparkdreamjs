...
export class LCDQueryClient {
  ...
  initiativesByCreator = async (params: QueryInitiativesByCreatorRequest): Promise<QueryInitiativesByCreatorResponse> => {
    const options: any = {
      params: {}
    };
    if (typeof params?.pagination !== "undefined") {
    ...
    const endpoint = `sparkdream/rep/v1/initiatives_by_creator/${params.creator}`;
    return await this.req.get<QueryInitiativesByCreatorResponse>(endpoint, options);
  };
  /* ProjectsByCreator Queries a list of ProjectsByCreator items. */
  projectsByCreator = async (params: QueryProjectsByCreatorRequest): Promise<QueryProjectsByCreatorResponse> => {
    const options: any = {
      params: {}
    };
    if (typeof params?.pagination !== "undefined") {
    ...
    const endpoint = `sparkdream/rep/v1/projects_by_creator/${params.creator}`;
    return await this.req.get<QueryProjectsByCreatorResponse>(endpoint, options);
  };
